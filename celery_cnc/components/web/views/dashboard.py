...
from celery_cnc.components.web.services import app_name, get_registry, open_db
from celery_cnc.core.db.models import TaskFilter, TimeRange
from celery_cnc.core.engine.brokers import list_queues
...
if TYPE_CHECKING:
    ...
    from celery_cnc.core.db.models import Task, TaskStats, Worker
    from celery_cnc.core.engine.brokers import QueueInfo
